...
class _GeographicLineDialogState extends ConsumerState<GeographicLineDialog> {
  ...
  // Local X/Y input removed: only lat/lon allowed
  ...
  void initState() {
    ...
    if (widget.existingLine != null) {
      ...
      // Always use geographic format for display
  ...
  void _save() {
    ...
    final point1 = GeographicPosition(latitude: lat1, longitude: lon1);
    final point2 = GeographicPosition(latitude: lat2, longitude: lon2);
